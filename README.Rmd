...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18675150.svg)](https://doi.org/10.5281/zenodo.18675150)
<!-- badges: end -->
...
This package has an [associated preprint on bioRxiv](https://doi.org/10.1101/2022.02.24.481854), please cite it if you use the package in your own work.

```
Flight RM, Bhatt PS, Moseley HNB (2025). “Information-Content-Informed Kendall-tau Correlation Methodology: Interpreting Missing Values as Useful Information.”
_bioRxiv_. doi:10.1101/2022.02.24.481854 
```
